...
class BedTools:
    ...
    def random(self, kind='human', length=200, number=100, fasta=None, seed=0, rm_N=True) -> Bed:
        """Get random region

        :param length: random region length.
        :param number: random region number.
        :param fasta: get random region from which genome, must be defined when rm_n=True
